...
class Location {
  ...
  String country;
  String time;
  Location({this.name,this.country,this.time});

  factory Location.fromJson(Map<String,dynamic> jsonA){
    return Location(
      name: jsonA['name'] as String,
...
class CurrentWeather{
  ...
  int humidity;
  Condition condition;
  CurrentWeather({this.temperature,this.wind_speed,this.pressure,this.humidity,this.condition});

  factory CurrentWeather.fromJson(Map<String,dynamic> jsonB){
    return CurrentWeather(
      temperature: jsonB["temp_c"] as double,
      wind_speed: jsonB["wind_kph"] as double,
